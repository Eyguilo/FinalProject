                        ...
                        <thead>
                            <tr>
                                <form id="listReservationsForm" method="POST"
                                    ...
                                    <th>
                                        <input type="text" id="locator" name="locator" autocomplete="off"
                                    ...
                                    <th>
                                        <select id="reservationDate" name="reservationDate"
                                            ...
                                            <?php
                                            $selectedDate = isset($_POST['reservationDate']) ? $_POST['reservationDate'] : "";
                                            echo "<option value='' selected>Booking date</option>";
                                            echo "<option value='NEWEST' " . ($selectedDate == 'NEWEST' ? 'selected' : '') . ">NEWEST</option>";
                                            echo "<option value='OLDEST' " . ($selectedDate == 'OLDEST' ? 'selected' : '') . ">OLDEST</option>";
                                            ?>
                                        </select>
                                    </th>
                                    <th>
